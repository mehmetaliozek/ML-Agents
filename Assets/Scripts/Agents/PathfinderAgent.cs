...
//    private float distanceToTargetLastStep;
...
//        isRevisited = false;
//        visitedRoom = null;
//        distanceToTargetLastStep = Vector3.Distance(transform.position, EnvironmentManager.Target.position);
//    }

//    public override void CollectObservations(VectorSensor sensor)
//    {
//        sensor.AddObservation(transform.InverseTransformPoint(EnvironmentManager.Target.position));
...
//        float currentDistance = Vector3.Distance(transform.position, EnvironmentManager.Target.position);

//        if (isTargetRoomFound)
//        {
//            if (currentDistance < distanceToTargetLastStep)
//            {
//                AddReward(approachReward / MaxStep);
//            }
//            else
//            {
//                AddReward(-approachReward / MaxStep);
...
//        distanceToTargetLastStep = currentDistance;
//    }
